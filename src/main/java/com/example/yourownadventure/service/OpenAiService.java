package com.example.yourownadventure.service;

import com.example.yourownadventure.dto.CompletionRequest;
import com.example.yourownadventure.dto.MyResponse;
import com.example.yourownadventure.dto.CompletionResponse;
...
public class OpenAiService {
    ...
    public MyResponse makeRequest(String userPrompt, String _systemMessage) {
        ...
        CompletionRequest requestDto = new CompletionRequest();
        ...
        requestDto.getMessages().add(new CompletionRequest.Message("system", _systemMessage));
        requestDto.getMessages().add(new CompletionRequest.Message("user", userPrompt));
